...
| Создание таблицы | ✅ | ✅ |
| Добавление колонки | ✅ | ✅ |
| Удаление/изменение колонки | ✅ | ⚠️ ограничено |
| Первичный/уникальный ключ | ✅ | ✅ (ограничено при alter) |
| Внешние ключи | ✅ | ✅ (создание/ADD COLUMN) |
| Индексы | ✅ | ✅ |
| CHECK-ограничения | ✅ | ✅ (ограничено при alter) |
| Детерминированный порядок diff | ✅ | ✅ |

Для SQLite неподдерживаемые операции изменения схемы завершаются явной ошибкой (например: изменение типа/default/NOT NULL или изменение существующих CHECK/FK ограничений).
